...
CFB_LOGI_MODEL <- function(ht=c(),at=c(),input_week,conferences = c(),previous_season=1,remove_fcs = FALSE){
...
CFB_LOGI_MODEL(ht=c('Tennessee'),at=c('Alabama'),input_week = 1,conferences = c(),previous_season=1,remove_fcs = FALSE)
